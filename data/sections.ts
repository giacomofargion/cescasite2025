  ...
  fargions: {
    ...
    items: [
      ...
      },
      {
        title: "Together with the rest",
        year: "2023",
        format: "Photo by Sam Walton",
        description:
          "Performed at IKLEKTIK, 26.09.23 and Morocco Bound Bookshop, 09.12.23.",
        image: "/images/together.png",
        url: "https://www.youtube.com/watch?v=c-U8yS6vYGE&ab_channel=giacomofargion",
      },
      {
        title: "Au Revoir",
        year: "2022",
        format: "Artwork by Sophie Wolfson.",
        description:
          "For two bass guitars, album mixed and mastered by Giacomo Fargion.",
        image: "/images/aurevoir.jpg",
        url: "https://thefargions.bandcamp.com/album/au-revoir",
      },
      {
        title: "Happy/Sad",
        year: "2022",
        format: "Mixed and mastered by Giacomo Fargion",
        description:
          "A selection of happy and sad songs, mostly sad.",
        image: "/images/happysad.png",
        url: "https://thefargions.bandcamp.com/album/happy-sad",
      },
      {
        title: "Songs from a warm kitchen",
        year: "2021",
        format: "",
        description:
          "Songs From A Warm Kitchen’ is comprised of short pieces, each one written as a response to the last throughoutlockdown, later in the project we collaborated with other artists to contribute to the works.",
        image: "/images/kitchen.png",
        url: "https://soundcloud.com/search?q=the%20fargions%20songs%20from%20a%20warm%20kitchen",
      },
    ],
  },
  contact: {
